...
(function(){
  ...
  const DICT = {
    en: {
      ...
      instapayNumberLabel: 'SEND TO THIS INSTAPAY NUMBER', copyLabel: 'COPY', copiedLabel: 'COPIED',
    ...
    ar: {
      ...
      instapayNumberLabel: 'حوّل على رقم إنستاباي', copyLabel: 'نسخ', copiedLabel: 'تم النسخ',
