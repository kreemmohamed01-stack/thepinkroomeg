...
(function(){
  ...
  const DICT = {
    en: {
      ...
      phoneNumber: 'Phone Number', phoneExample: 'e.g. +20 100 123 4567', phoneExampleLocal: '100 123 4567',
      ...
      stateRegion: 'State / Region', stateRegionPh: 'State / Region',
      country_EG: 'Egypt', country_SA: 'Saudi Arabia', country_AE: 'United Arab Emirates',
      country_QA: 'Qatar', country_IQ: 'Iraq', country_TN: 'Tunisia', country_JO: 'Jordan',
      country_OM: 'Oman', country_KW: 'Kuwait', country_MA: 'Morocco', country_DZ: 'Algeria',
      ...
      secureEncrypted: 'Secure & Encrypted', paymentInfoSafe: 'Your payment information is safe',
      fastSecure: 'Fast & Secure', availableAllEgypt: 'Available all over Egypt',
      instapayNumberLabel: 'InstaPay Number', copyLabel: 'Copy', copiedLabel: 'Copied',
      instapayIntro: 'Transfer the total amount to our InstaPay number, then attach your transfer receipt below.',
      instapaySenderLabel: 'Your Number (sender)', instapaySenderPh: 'The number you paid from',
      instapayNote: 'Make sure the receipt is clear and shows the transfer amount, so we can confirm your payment.',
      errInstapaySender: 'Please enter the number you transferred from.',
      instapayUploadLabel: 'Attach your transfer receipt', instapayDropText: 'Click or drag a screenshot here',
      instapayDropHint: 'JPG or PNG, up to 8MB', removeLabel: 'Remove',
      uploadingLabel: 'Uploading…', uploadedLabel: 'Uploaded', uploadFailedLabel: 'Upload failed — try again',
      instapayNotImage: 'Please attach an image file.', instapayTooLarge: 'Image is too large (max 8MB).',
      errInstapayReceipt: 'Please attach a screenshot of your InstaPay transfer before continuing.',
      ...
      subtotalLabel: 'Subtotal', discountLabel: 'Discount', shippingLabel: 'Shipping', includesWeightSurcharge: 'incl. weight surcharge',
    ...
    ar: {
      ...
      phoneNumber: 'رقم الهاتف', phoneExample: 'مثال: +20 100 123 4567', phoneExampleLocal: '100 123 4567',
      ...
      stateRegion: 'الولاية / المنطقة', stateRegionPh: 'الولاية / المنطقة',
      country_EG: 'مصر', country_SA: 'السعودية', country_AE: 'الإمارات العربية المتحدة',
      country_QA: 'قطر', country_IQ: 'العراق', country_TN: 'تونس', country_JO: 'الأردن',
      country_OM: 'عُمان', country_KW: 'الكويت', country_MA: 'المغرب', country_DZ: 'الجزائر',
      ...
      secureEncrypted: 'آمن ومشفّر', paymentInfoSafe: 'بيانات الدفع الخاصة بك محمية',
      fastSecure: 'سريع وآمن', availableAllEgypt: 'متاح في جميع أنحاء مصر',
      instapayNumberLabel: 'رقم إنستاباي', copyLabel: 'نسخ', copiedLabel: 'تم النسخ',
      instapayIntro: 'حوّلي المبلغ الإجمالي على رقم إنستاباي الخاص بنا، ثم أرفقي صورة إيصال التحويل بالأسفل.',
      instapaySenderLabel: 'رقمك (المُحوِّل)', instapaySenderPh: 'الرقم الذي حوّلتِ منه',
      instapayNote: 'تأكدي أن صورة الإيصال واضحة ويظهر بها مبلغ التحويل، حتى نتمكن من تأكيد الدفع.',
      errInstapaySender: 'من فضلك أدخلي الرقم الذي حوّلتِ منه.',
      instapayUploadLabel: 'أرفق صورة إيصال التحويل', instapayDropText: 'اضغط أو اسحب صورة هنا',
      instapayDropHint: 'JPG أو PNG، حتى 8 ميجا', removeLabel: 'إزالة',
      uploadingLabel: 'جاري الرفع…', uploadedLabel: 'تم الرفع', uploadFailedLabel: 'فشل الرفع — حاول مرة أخرى',
      instapayNotImage: 'من فضلك أرفق ملف صورة.', instapayTooLarge: 'حجم الصورة كبير جداً (الحد الأقصى 8 ميجا).',
      errInstapayReceipt: 'من فضلك أرفق صورة إيصال تحويل الإنستاباي قبل المتابعة.',
      ...
      subtotalLabel: 'الإجمالي الفرعي', discountLabel: 'الخصم', shippingLabel: 'الشحن', includesWeightSurcharge: 'شامل رسوم الوزن',
